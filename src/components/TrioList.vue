      ...
      <div class="row trio-content">
        <div class="col-md-4">
          ...
          <div class="searchBorder">
            <input type="text" class="form-control input_hasImg" placeholder='请输入关键字' v-model="input0">
        ...
        <div class="col-md-4">
          ...
          <div class="searchBorder">
            <input type="text" class="form-control input_hasImg" placeholder='请输入关键字' v-model="input1">
        ...
        <div class="col-md-4">
          ...
          <div class="searchBorder">
            <input type="text" class="form-control input_hasImg" placeholder='请输入关键字' v-model="input2">
